    ...
    return (
        <>
            <div className="navbar">
                ...
                {/* AJOUTÉ : Bouton Hamburger pour mobile */}
                {/* Ce bouton bascule l'état 'open' et est affiché sur mobile via le CSS */}
                <button 
                ...
                >
                    {/* Vous pouvez utiliser une icône ici (ex: ☰ ou un composant) */}
                    {open ? '✕' : '☰'} 
                </button>
            </div>
            
            {/* ======================================================= */}
            {/* AJOUTÉ : Le Menu Déroulant Mobile (Popover) */}
            {/* ======================================================= */}
                        ...
                        { isAuthorized ? (
                            ...
                            <>
                                ...
                                <li>
                                    <Link 
                                        to="/logout" 
                                        onClick={handleMobileLogout} // Utilisation de la fonction qui ferme le menu
                                    >
                                        Déconnexion
                                    </Link>
                                </li>
